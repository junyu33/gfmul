...
_sage_const_2 = Integer(2); _sage_const_32 = Integer(32); _sage_const_7 = Integer(7); _sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_16 = Integer(16)
import time
...
# 定义模多项式
mod_poly = x**_sage_const_32  + x**_sage_const_7  + x**_sage_const_3  + x**_sage_const_2  + _sage_const_1 

# 定义有限域 GF(2^128)
K = GF(_sage_const_2 **_sage_const_32 , modulus=mod_poly, names=('a',)); (a,) = K._first_ngens(1)
...
print(hex(mul_result_int)[_sage_const_2 :].zfill(_sage_const_16 ))
